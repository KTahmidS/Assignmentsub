...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (isset($_POST['add_assignment'])) {
        ...
        $stmt = $conn->prepare("INSERT INTO assignments (title, description, deadline) VALUES (?, ?, ?)");
    ...
    if (isset($_POST['delete_assignment'])) {
        ...
        $stmt = $conn->prepare("DELETE FROM student_assignments WHERE assignment_id = ?");
...
// Get all assignments
$assignments = $conn->query("SELECT * FROM assignments ORDER BY deadline");
